...
public class ProductResourceIntTest {
    ...
    private static final LocalDate DEFAULT_MF_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_MF_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getMfDate()).isEqualTo(DEFAULT_MF_DATE);
        assertThat(testProduct.getExpDate()).isEqualTo(DEFAULT_EXP_DATE);
    ...
    @Test
    @Transactional
    public void checkMfDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setMfDate(null);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].mfDate").value(hasItem(DEFAULT_MF_DATE.toString())))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.mfDate").value(DEFAULT_MF_DATE.toString()))
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getMfDate()).isEqualTo(UPDATED_MF_DATE);
        assertThat(testProduct.getExpDate()).isEqualTo(UPDATED_EXP_DATE);
