...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mocean.pos.domain.Inventory.class.getName(), jcacheConfiguration);
            cm.createCache(com.mocean.pos.domain.Inventory.class.getName() + ".products", jcacheConfiguration);
            ...
            cm.createCache(com.mocean.pos.domain.Bill.class.getName() + ".billNos", jcacheConfiguration);
